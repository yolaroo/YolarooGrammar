...
@implementation GrammarWordListView
...
{
    GrammarWordsFromSemanticTypeView* detailController = [self.storyboard instantiateViewControllerWithIdentifier:@"GrammarWordsFromSemanticTypeViewID"];
...
- (NSArray*) myArraySetter {
    @try {
        NSArray*mine = [self completeGrammarWordSemanticTypeList: self.managedObjectContext];
